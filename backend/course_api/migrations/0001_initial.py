    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_number', models.CharField(help_text='Registration number in format GPR3/XXXXXX/2025', max_length=20, unique=True, validators=[django.core.validators.RegexValidator(message='Registration number must be in format GPR3/XXXXXX/2025', regex='^GPR3/\\d{6}/2025$')])),
